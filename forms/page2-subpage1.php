<?php
/**
 * Subpage 1 in Page 2 section in admin theme settings.
...
// Database table
$db_table = $wpdb->prefix . 'page2_subpage1';
...
rt_admin_form_intro( 'This is an introductionary text for Subpage 1 in Page 2 section.' );
